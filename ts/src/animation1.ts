...
export class Animation1 extends baseapp.BaseApp
{
    ...
    defaultParameters: baseapp.TAnimation1Parameters = { move: true, speed: 0.01, gravity:0.02, color0:"#A0A0A0", texture: 'geotriangle2', fov: 60, movetail: true, typelight:'point light',  sling:117, shininess:11.0 };
