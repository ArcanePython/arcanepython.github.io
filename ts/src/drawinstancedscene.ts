...
initScene(gl: WebGL2RenderingContext, cap: scene.TAnimation1Parameters,  p: twgl.ProgramInfo) 
{
  ...
  gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([
    /*     -0.1,  0.4,
      ...
      -0.4,  0.1,
       0.4, -0.1,
       0.4,  0.1, */  // Lx Corrected Greggs coords list to have the triangles of each spoke turn in the same direction.
                     // This allowed  gl.enable(gl.DEPTH_TEST) and gl.enable(gl.CULL_FACE) in the
                     // preparation of wrapper animation1.Animation1.
