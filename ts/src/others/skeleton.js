...
class Skeleton extends baseapp.BaseApp {
    constructor(cgl, capp, dictpar, cdiv) {
        ...
        this.animationParameters = { gravity: 0.02, move: false, color0: "#00A000", speed: 0.4, texture: 'geotriangle2', fov: 60, movetail: true, sling: 140, shininess: 0.5, typelight: 'point light' };
