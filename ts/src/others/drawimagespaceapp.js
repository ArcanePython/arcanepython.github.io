...
const vs = `#version 300 es
        ...
        void main()
        {
          ...
          gl_Position = vec4(4.f * float(uint(gl_VertexID) % 2u) - 1.0f, 4.f*float(uint(gl_VertexID) / 2u) - 1.0f, 1.0, 1.0);
        ...
        void main()
        {
          ...
          vec2 texcoord1 = vec2(  px, u_imageSize.y - py) / u_imageSize;
...
export class drawimagespace extends baseapp.BaseApp
{
      ...
      cxdshift: number=6.0;
      cydshift: number=4.0;
      cxshiftmax: number=1000;
      cyshiftmax: number=400;
      currentTexture = "geotriangle2";
      ny = 0.0;
      txtaspect: number = 1.0;

      static instance: drawimagespace|null=null;
      static zoomVelocity = 0.075;
      static animationVelocity=0.25;

      public static releaseCombo()
      { drawimagespace.instance=null; }
      ...
      render(time: number)
      {
        if (this.textures!=null)
        {
          ...
          //  gl.bindTexture(gl.TEXTURE_2D, texture);
            ...
            // The texture is sampled according to cdiv.
            // cdiv determines how many texture images are shown in vertical direction in tealed mode.
            ...
            document.getElementById("cdiv")!.innerHTML ="draw "+time+"<br>xshift="+Math.round(this.cxshift)+"<br>yshift="+this.cyshift+"<br>"+" c.width="+gl.canvas.width+
...
*/ 
//# sourceMappingURL=drawimagespaceapp.js.map