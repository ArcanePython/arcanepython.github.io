...
export class twglbasescene
{
 ...
 public initSingleObject(gl: WebGL2RenderingContext, program: WebGLProgram, setGeometry: (gl: WebGL2RenderingContext)=>void, setNormals: (gl: WebGL2RenderingContext)=>void)
 {
