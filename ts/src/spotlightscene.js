...
class SpotLightScene extends twglbasescene_1.twglbasescene {
    constructor() {
        super();
  ...
  `;
    ...
    onChangeTextureCombo(value) {
        ...
        if (s == "directed light")
            SpotLightScene.instance.typelight = 0; // gl.uniform1i(this.typelightLocation!,0);
        else if (s == "point light")
            SpotLightScene.instance.typelight = 1; // gl.uniform1i(this.typelightLocation!,1);
        else if (s == "spot light")
            SpotLightScene.instance.typelight = 2; //gl.uniform1i(this.typelightLocation!,2);
    }
...
//# sourceMappingURL=spotlightscene.js.map